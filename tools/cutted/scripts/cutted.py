...
CAMERA_GROUP_SPEAKER_HOLD_SECONDS = 4.2
CAMERA_GROUP_REACTION_HOLD_SECONDS = 3.2
...
AI_DIRECTOR_MAX_GROUP_DURATION_RATIO = 0.68
AI_DIRECTOR_MIN_ACTIVE_DURATION_RATIO = 0.28
