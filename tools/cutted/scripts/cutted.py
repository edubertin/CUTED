...
.cuted-control-surface-slot{display:none;position:relative;z-index:90;margin:-22px 14px 10px;justify-content:center}.cuted-control-surface-slot:empty{display:none}.card[open]>.cuted-control-surface-slot:not(:empty){display:flex}.cuted-control-surface-slot .cuted-control-bar{width:min(82%,1160px);min-width:min(100%,980px);min-height:118px;padding:14px 22px;border-radius:18px}.cuted-control-surface-slot .cuted-render-zone{justify-content:flex-end;overflow:visible}.cuted-control-surface-slot .cuted-tile-button{flex:0 0 78px;width:78px;height:72px;font-size:34px}.cuted-control-surface-slot .cuted-insert-button span{font-size:20px}.cuted-control-surface-slot .cuted-format-trigger{flex:0 0 154px;width:154px;height:72px}.cuted-control-surface-slot .cuted-divider{flex:0 0 1px;height:58px;margin:0 12px}.cuted-control-surface-slot .cuted-audio-group{flex:0 0 252px;min-width:238px}.cuted-control-surface-slot .cuted-ready-region{flex:0 0 154px;width:154px;min-height:72px;margin-left:auto}
