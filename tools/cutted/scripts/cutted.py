...
GROUP_FIT_LOGO_TOP_RATIO = 0.075
GROUP_FIT_LOGO_WIDTH_RATIO = 0.34
GROUP_FIT_MIN_HOLD_SECONDS = 3.0
AI_DIRECTOR_MIN_MOVE_HOLD_SECONDS = 1.6
...
def group_fit_logo_source_filter(preset: PlatformPreset, index: int) -> str:
    ...
    return (
        ...
        f"scale={width}:-1,format=rgba[cp{index}logo]"
    )
