(function registerCutedControlBar(global) {
  ...
  function bindEvents(container, elements, state, callbacks, settings, statusClock) {
    const setStatus = (status, holdMs = 2600) => {
      ...
      if (!state.status || state.status.progress !== null || holdMs <= 0) return;
  ...
  function renderControlBar() {
    return `
      <nav class="cuted-control-bar" aria-label="CUTED video controls">
        <div class="cuted-status-strip" data-tone="neutral" data-cuted-status hidden>
        ...
        <div class="cuted-control-group cuted-tool-group">
